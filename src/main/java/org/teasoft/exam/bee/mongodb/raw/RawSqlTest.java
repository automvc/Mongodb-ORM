...
//	String result0=mongodbSql.selectJson(CommandString.find27);
//	int r0=mongodbSql.modify(CommandString.updateMany);
//	int r0=mongodbSql.modify(CommandString.updateOne22);
//	int r0=mongodbSql.modify(CommandString.updateOne23); //set部分为空
